...
INSERT into ingredients (id, ingredient, fats, carbs, protein, type) values (28, 'Onion', 0.13, 16, 1.47, 'Vegetable');
INSERT into ingredients (id, ingredient, fats, carbs, protein, type) values (29, 'Soy Sauce', 0.01, 1.22, 1, 'Other');
INSERT into ingredients (id, ingredient, fats, carbs, protein, type) values (30, 'Worcestershire Sauce', 0.01, 1.22, 1, 'Other');


INSERT into recipes (id, title, description, number_of_portions, vegan, vegetarian, junk_food, image) values (1, 'Hummus', 'In the bowl of a food processor, combine the tahini and lemon juice and process for 1 minute, 
...
Taste for salt and adjust as needed. Serve hummus with a drizzle of olive oil and dash of paprika. Store homemade hummus in an airtight container and refrigerate up to one week.', 6, 'true', 'true', 'false', 'http://localhost:9000/images/hummus.jpg');
...
INSERT into recipes (id, title, description, number_of_portions, vegan, vegetarian, junk_food, image) values (2, 'Peanut butter cookies', 'Preheat oven to 350 degrees F. Line a baking sheet with parchment paper, then set aside.
...
Let cookies rest on the baking sheet for 5-10 minutes, then transfer to a wire cooling rack to cool completely.', 24, 'false', 'true', 'false', 'http://localhost:9000/images/pbc.jpg');
...
INSERT into recipes (id, title, description, number_of_portions, image) values (3, 'Easy pancakes', 'Put 100g plain flour, 2 large eggs, 300ml milk, 1 tbsp sunflower or vegetable oil and a pinch of salt into a bowl or large jug, then whisk to a smooth batter. Set aside for 30 mins to rest if you have time, or start cooking straight away. 
Set a medium frying pan or crêpe pan over a medium heat and carefully wipe it with some oiled kitchen paper. When hot, cook your pancakes for 1 min on each side until golden, keeping them warm in a low oven as you go. Serve with lemon wedges and caster sugar, or your favourite filling. Once cold, you can layer the pancakes between baking parchment, then wrap in cling film and freeze for up to 2 months.', 6, 'http://localhost:9000/images/pancakes.jpeg');
...
INSERT into recipes (id, title, description, number_of_portions, image) values (4, 'Baked chicken breasts', 'Heat the oven. Preheat oven to 450°F. Season the chicken. Place the chicken breasts in a single layer in a large baking dish. Brush on both sides (turning once) evenly with the melted butter or olive oil. In a separate small bowl, whisk the salt, pepper, garlic powder and paprika until combined. Then sprinkle the mixture evenly over the chicken on both sides. Bake for 15-18 minutes, or until the chicken is cooked through and no longer pink. ', 4, 'http://localhost:9000/images/bcb.jpg');
...
INSERT into recipes (id, title, description, number_of_portions, vegan, vegetarian, junk_food, image) values (5, 'French fries', 'Heat oil and slice the potatoes. Fry them in about 6 batches for 5-6 minutes until golden brown. 
Don’t overcrowd them by placing too many in at a time, they won’t be as crispy. Place them bake on paper towels and sprinkle immediately with salt. ', 3, 'true', 'true', 'true', 'http://localhost:9000/images/ff.jpg');
...
INSERT into recipes (id, title, description, number_of_portions, vegan, vegetarian, junk_food, image) values (6, 'Salami pizza', 'Place Pizza Dough on a large sheet of parchment paper. 
Cover with a damp towel; let rise in a warm place (85°), free from drafts, 45 minutes. While dough rises, heat a large nonstick skillet over medium-high heat. Add oil; swirl to coat.
 ...
 Bake an additional 10 minutes or until crust is golden and cheese melts. Remove from oven; let stand 5 minutes. Cut into wedges.', 2, 'false', 'false', 'true', 'http://localhost:9000/images/salami.jpg');
...
insert into recipes (id, title, description, number_of_portions, vegan, vegetarian, junk_food, image) values (
	7,
	'Best Hamburger Ever',
	'Step 1
	...
	false,
	true,
	'http://localhost:9000/images/burger.jpg');

INSERT into recipe_ingredients (recipe_id, ingredient_id, measurement_id, quantity) values (7, 25, 1, 1.5);
INSERT into recipe_ingredients (recipe_id, ingredient_id, measurement_id, quantity) values (7, 28, 1, 50);
INSERT into recipe_ingredients (recipe_id, ingredient_id, measurement_id, quantity) values (7, 21, 1, 50);
INSERT into recipe_ingredients (recipe_id, ingredient_id, measurement_id, quantity) values (7, 9, 1, 50);
INSERT into recipe_ingredients (recipe_id, ingredient_id, measurement_id, quantity) values (7, 4, 1, 10);
INSERT into recipe_ingredients (recipe_id, ingredient_id, measurement_id, quantity) values (7, 15, 1, 2);
INSERT into recipe_ingredients (recipe_id, ingredient_id, measurement_id, quantity) values (7, 16, 1, 2);
INSERT into recipe_ingredients (recipe_id, ingredient_id, measurement_id, quantity) values (7, 29, 3, 1);
INSERT into recipe_ingredients (recipe_id, ingredient_id, measurement_id, quantity) values (7, 30, 3, 1);
...
insert into history (id, user_id, recipe_id, servings, date) values (13, 3, 7, 4, now() - interval '3 days');
